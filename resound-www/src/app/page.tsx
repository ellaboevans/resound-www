  ...
  return (
    <div className="group/stage relative isolate mx-auto w-full max-w-full overflow-hidden rounded-lg border border-white/10 bg-[#030504] shadow-2xl shadow-black/50">
      ...
      <div className="relative aspect-10/13 min-h-[680px] overflow-hidden sm:aspect-4/3 sm:min-h-175 lg:aspect-video lg:min-h-180 xl:aspect-16/8.5">
        ...
        <div className="absolute top-[30%] left-[35%] lg:left-1/2 z-10 w-[min(88%,360px)] -translate-x-1/2 rounded-[1.1rem] bg-black px-3.5 pt-3 pb-3.5 text-white shadow-2xl shadow-black/60 transition-transform duration-300 ease-out hover:-translate-y-1 sm:top-[31%] sm:w-[min(78%,400px)] sm:px-4.5 sm:pt-3.5 sm:pb-4.5 lg:top-[35%]">
